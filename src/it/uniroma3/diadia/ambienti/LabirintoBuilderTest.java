...
public class LabirintoBuilderTest {
	...
	public void testBilocale() {
		Labirinto bilocale = labirintoBuilder
				...
				.getLabirinto();
		assertEquals(bilocale.getStanzaIngresso(),bilocale.getStanzaVincente().getStanzaAdiacente("sud"));
		assertEquals(1,bilocale.getStanzaIngresso().getDirezioni().size());
		assertEquals(1,bilocale.getStanzaVincente().getDirezioni().size());
	}
	...
	public void testPiuDiQuattroAdiacenti() {
		...
		assertEquals(mappa,maze.getStanzaIngresso().getMapStanzeAdiacenti());
	}
	...
	public void testAggiuntaAttrezziAStanze_Iniziale() {
		...
		assertEquals(attrezzo,maze.getStanzaIngresso().getAttrezzo(nomeAttrezzo));
	}
	...
	public void testLabirintoCompletoConTutteLeStanze() {
		...
		assertEquals(a1,corridoio.getAttrezzi().get("chiave"));
		assertEquals(a2,corridoio.getAttrezzi().get("lanterna"));
	}
}
